                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <?php
                              if (isset($_POST['edit'])) {
                                $save = mysqli_query($con, "UPDATE tb_master_matkul SET mk='$_POST[mk]' WHERE id_mk='$_POST[id]' ");
                                if ($save) {
                                  echo "<script>
                        alert('Data diubah !');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
        if (isset($_POST['save'])) {
          $save = mysqli_query($con, "INSERT INTO tb_master_mk VALUES(NULL,'$_POST[kode]','$_POST[mk]') ");
          if ($save) {
            echo "<script>
